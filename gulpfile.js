...
const srcJS = [node_path + "jquery/dist/jquery.min.js", node_path + "slick-carousel/slick/slick.min.js", asset_path + "script.js"]

gulp.task("pack-js", function () {
	return gulp.src(srcJS).pipe(concat("bundle.js")).pipe(minify()).pipe(gulp.dest("public/assets/js"))
})

const deferJS = [node_path + "jquery-validation/dist/jquery.validate.min.js", asset_path + "defer.js"]
...
gulp.task("copy-json", function () {
	return gulp.src("src/assets/json/**/*.*").pipe(gulp.dest("./public/assets/json/"))
})
...
const copySrc = ["src/sitemap.xml", "src/robots.txt", "src/.htaccess", "src/favicon.ico"]
...
gulp.task("default", gulp.series("html", "copy-src-js", "pack-js", "copy-vid", "copy-img", "copy-font", "scss", "purgecss", "defer-js", "copy-json", "copy"))
...
gulp.task("watch", function () {
	...
	gulp.watch("src/assets/json/**/*.*", gulp.series("copy-json"))
